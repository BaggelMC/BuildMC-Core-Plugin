...
public class Campfire extends Protection {
    ...
    public String getTranslationBaseKey() {
        return "claims.flags.interaction-campfire";
    }
    ...
    public @NotNull GuiItem getDisplay(@NotNull Player uiHolder, @NotNull Gui gui) {
        ...
        ItemStack displayBase = new ItemStack(Material.CAMPFIRE);
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        var t = block.getType();
        if (!t.equals(Material.CAMPFIRE) && !t.equals(Material.SOUL_CAMPFIRE)) return;
